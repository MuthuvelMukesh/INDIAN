...
class MarketDataService:
    """Coordinate cache lookup and provider fetches without knowing either implementation."""
    ...
    def get_candles(self, query: HistoricalQuery) -> list[Candle]:
        ...
        candles = sorted(self.provider.fetch_candles(query), key=lambda item: item.timestamp)
